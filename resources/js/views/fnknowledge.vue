            ...
            <div class="items" v-for="(item,index) in nowdata" :key="index">
              <div class="item_dif">
                ...
                <div class="textDiv_palr24_fl1">
                  <div class="icon_fs14_fw400_coWhite_patb4_palr16_bgGreen_br100_mab8_dii">{{nowClassName}}</div>
                  <div class="title_fs32_fw400_co212121_ellipsis1_lh12">{{item.title}}</div>
                  <hr class="_matb16">
